...
$(document).ready(function() {
    ...
    //------------- Datepicker -------------//
    $("#basic-datepicker").bDatepicker({format: 'dd/mm/yyyy'});
    $("#basic-datepicker2").bDatepicker({format: 'dd/mm/yyyy'});
    $("#member-birthday").bDatepicker({format: 'dd/mm/yyyy'});
    $("#member-date").bDatepicker({format: 'dd/mm/yyyy'});
    $("#search-from").bDatepicker({format: 'dd/mm/yyyy'});
    $("#search-to").bDatepicker({format: 'dd/mm/yyyy'});
    $("#creadit-on").bDatepicker({format: 'dd/mm/yyyy'});
    //multiple date
